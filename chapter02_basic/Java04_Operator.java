/*
  ...
  TODO 018 基础语法 运算符 算术运算符 二元运算符

  TODO 019 基础语法 运算符 算术运算符 一元运算符
 */
...
public class Java04_Operator {
    public static void main(String[] args) {
        ...
        System.out.println(1 / 2); // 0.5 （int, int） => int 实际上结果为0
